...
func (_m *Request) AbortWithError(err error) {
	_m.Called(err)
}
...
// Ajax provides a mock function with given fields:
func (_m *Request) Ajax() bool {
	ret := _m.Called()
...
func (_m *Request) All() map[string]interface{} {
	ret := _m.Called()
...
// ExpectsJson provides a mock function with given fields:
func (_m *Request) ExpectsJson() bool {
	ret := _m.Called()
...
func (_m *Request) InputArray(key string, defaultValue ...[]string) []string {
	_va := make([]interface{}, len(defaultValue))
	for _i := range defaultValue {
		_va[_i] = defaultValue[_i]
	}
...
// Pjax provides a mock function with given fields:
func (_m *Request) Pjax() bool {
	ret := _m.Called()
...
func (_m *Request) Queries() map[string]string {
	ret := _m.Called()
...
// WantsJson provides a mock function with given fields:
func (_m *Request) WantsJson() bool {
	ret := _m.Called()

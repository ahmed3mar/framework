...
func (_m *ContextRequest) Has(key string) bool {
	ret := _m.Called(key)
...
type mockConstructorTestingTNewContextRequest interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewContextRequest(t mockConstructorTestingTNewContextRequest) *ContextRequest {
	mock := &ContextRequest{}
	mock.Mock.Test(t)

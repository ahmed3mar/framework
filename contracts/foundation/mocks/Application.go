...
import (
	...
	exception "github.com/goravel/framework/contracts/exception"
...
// MakeException provides a mock function with given fields:
func (_m *Application) MakeException() exception.Exception {
	ret := _m.Called()

	var r0 exception.Exception
	if rf, ok := ret.Get(0).(func() exception.Exception); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
